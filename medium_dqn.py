...
class Qnetwork():
    def __init__(self,h_size):
        ...
        print("stramA", self.streamA.get_shape())
...
pre_train_steps = 100#00 #How many steps of random actions before training begins.
        ...
        while stepInEpi < max_epLength: #If the agent takes longer than max_epLength moves to reach either of the blocks, end the trial.
            ...
            if total_steps > pre_train_steps:
                ...
                if total_steps % (update_freq) == 0:
                    trainBatch = myBuffer.sample(batch_size) #Get a random batch of experiences. #shape:(batchsize,5) (5 weil s,a,r,s2,t)
